...
import { Code2, Github, Mail, Lock, Loader2 } from 'lucide-react';
...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // No navigate here - the useEffect above will handle it when user state updates
        } catch (err) {
        ...
        <div className="min-h-screen flex items-center justify-center bg-background px-4">
            ...
            >
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-zinc-500">Log in to your CodeSync account</p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                    <button
                        ...
                        disabled={isLoggingIn}
                        className="flex items-center justify-center gap-2 py-3 border border-zinc-800 rounded-lg hover:bg-zinc-800 transition-all font-medium disabled:opacity-50 w-full"
                    >
                        {isLoggingIn ? (
                ...
                <p className="mt-8 text-center text-sm text-zinc-500">
                    Don't have an account? <Link to="/register" state={{ from }} className="text-primary hover:underline font-medium">Sign up</Link>
                </p>
            </motion.div>
        </div>
    );
